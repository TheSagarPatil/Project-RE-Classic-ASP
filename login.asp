...
<br/><br/>
	<div class="container containerMain" id="Login2" >
		<form id="login" name="login" action="action_LoginAndForwardToHome.asp" method="post" class="col-lg-offset-4 col-lg-4">
			...
			<div class="row">
				<div class="col-xs-12 col-md-4 col-lg-8">
					<label for="uname">Password :<span style="color:red;">*</span></label><input type="password" name="txt_password" class="form-control" id="uname" required >
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<div class="form-group">
						...
						<select name="loginType" class="form-control" id="signInAs">
							...
							<!-- 
							<option value="dev">Developer (Representative) [Work in Progress]</option>
			...
			<div class="row">
				...
				<div class="col-xs-6 col-md-8 text-right">
					<!--<a href="ForgotPassword.asp">Forgot Password</a><br>-->
